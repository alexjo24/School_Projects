...
title('Force-displacement, B-direction','FontSize', 20)
xlabel('Displacement [mm]','FontSize', 20)
ylabel('Force [N]','FontSize', 20)
grid on

figure 
plot(u_plot2,f_plot2);
title('Force-displacement, A-direction','FontSize', 20)
xlabel('Displacement [mm]','FontSize', 20)
ylabel('Force [N]','FontSize', 20)
grid on
...
title( 'A-direction and B-direction','FontSize', 20)
xlabel('Displacement [mm]','FontSize', 20)
